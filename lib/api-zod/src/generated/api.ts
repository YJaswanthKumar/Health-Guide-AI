...
export const ListPlansResponseItem = zod.object({
  ...
  "title": zod.string(),
  "type": zod.string(),
  "category": zod.string().nullish().describe('Plan category, e.g. medication | diet | fitness | recovery | custom.'),
  "description": zod.string().nullish(),
  "status": zod.string(),
  "startDate": zod.string().nullish(),
  "endDate": zod.string().nullish(),
  "durationDays": zod.number().nullish(),
  "completedDays": zod.number().nullish().describe('Number of days completed so far (agent-supplied or derived).'),
  "remainingDays": zod.number().nullish().describe('Number of days left in the plan (agent-supplied or derived).'),
  "progressPercentage": zod.number().nullish().describe('Stored progress percentage (0-100), agent-supplied or derived.'),
  "currentDay": zod.number().nullish().describe('Which day of the plan the user is currently on (1-indexed).'),
  "sourceAgent": zod.string().nullish().describe('Who created the plan — \"user\" or \"agent3\".'),
  "progress": zod.number().nullish().describe('Computed progress percentage (0-100) — prefers progressPercentage, falls back to elapsed-time estimate.'),
  "daysRemaining": zod.number().nullish().describe('Computed days remaining until endDate — prefers remainingDays, falls back to elapsed-time estimate.'),
